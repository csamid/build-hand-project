...
/*
  ...
  FutekVoltage = map(FutekBinary,0,1023,0,5000);
*/
  ...
  if (newDataReady) {
    if (millis() > t + serialPrintInterval) {
      ...
      Serial.println(grams); //Serial.print(',');
      //Serial.print(FutekVoltage); Serial.print(',');
      //Serial.println(FutekVoltage);
      newDataReady = 0;
      t = millis();
    }
  }
